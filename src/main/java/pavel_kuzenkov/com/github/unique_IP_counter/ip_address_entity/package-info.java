 ...
 * немного памяти. Решено передавать в хранилище адрес в массиве с примитивами int, а не short, (не смотря на то, что
 * это массив, и в нём для примитива short должно выделяться 2 байта, а не 4) т.к. в отдельный момент
 * времени такой массив будет существовать всего один.
 *
